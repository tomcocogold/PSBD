...
def everything():
    ...
    # register
    Label(frame, text="Rejestracja", font=("Arial", 20), bg=color, pady = 30).grid(row=0, column=0, sticky="nsew")

    # Name
    Label(frame, text="Imię", font=('Arial', 10), bg=color, pady=5).grid(row=5, column=0, sticky="nsew")
    ...
    Label(frame, text="", font=('Arial', 10), bg=color, pady=5).grid(row=45, column=0, sticky="nsew")
    Checkbutton(frame, text="Korepetytor", font=('Arial', 10),command=tutor).grid(row=50, column=0, sticky="w")
    Label(frame, text="", font=('Arial', 10),bg=color, pady=5).grid(row=52, column=0, sticky="nsew")
    Checkbutton(frame, text="Uczeń", font=('Arial', 10), command=pupil).grid(row=55, column=0, sticky="w")

    Label(frame, text="", font=('Arial', 10), bg=color, pady=5).grid(row=60, column=0, sticky="nsew")
    Button(frame, text="Utwórz konto", command=create_account).grid(row=65, column=0, sticky="nsew")

    Label(frame, text="", font=('Arial', 10), bg=color).grid(row=70, column=0, sticky="nsew")
